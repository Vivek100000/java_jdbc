   ...
   public static void main(String[] args) 
	{
       ...
       try
       {
           ...
           String sql = "UPDATE records set empcode=? WHERE empname=?";
           stmt = conn.prepareStatement(sql);

           //Bind values into the parameters.
           stmt.setInt(1, 36667); //This will set employee code
           stmt.setString(2, "ravi"); // This will select the record of the employee whose age is needed to be updated
